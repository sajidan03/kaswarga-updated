                    ...
                    <main className="flex w-full max-w-[335px] flex-col lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-t-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-lg lg:rounded-l-lg lg:rounded-tr-none lg:p-12 dark:bg-gray-800">
                            <div className="mb-6 flex items-center">
                                <div className="mr-3 flex h-10 w-10 items-center justify-center rounded-full bg-teal-100 text-teal-600 dark:bg-teal-900 dark:text-teal-300">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                    </svg>
                                </div>
                                <h1 className="text-2xl font-bold text-teal-700 dark:text-teal-400">KasWarga</h1>
                            </div>
